    ...
    class Conexao
    {
        ...
        public SqlConnection conectar()
        {
            try
            {
                ...
                String strConexao = "Password=teste; Persist Security Info=True; User ID=thamiristeste; Initial Catalog=versami; Data Source=" + Environment.MachineName + "\\SqlExpress";
