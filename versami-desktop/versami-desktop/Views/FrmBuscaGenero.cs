...
namespace versami_desktop.Views
{
    public partial class FrmBuscaGenero: Form
    {
        ...
        public void formataGrid()
        {
            ...
            dataGridView1.Columns[1].HeaderText = "NOME DO GENERO";
        ...
        {
            dataGridView1.DataSource = lc.buscaGenero(txtNome.Text);
            formataGrid();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                ...
                gen.setType(dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString());
